...
module edb_top (
    ...
    input  [4:0] la0_probe1,
    input  [7:0] la0_probe2,
    input  [7:0] la0_probe3,
    input  [4:0] la0_probe4,
    input  la0_probe5,
    input  la0_probe6,
    input  [7:0] la0_probe7,
    input  [4:0] la0_probe8,
    ...
    input  la0_probe16,
    input  la0_probe17,
    input  [6:0] la0_probe18,
    input  [7:0] la0_probe19,
    input  la0_probe20,
    input  la0_probe21,
    input  la0_probe22,
    ...
    input  la0_probe25,
    input  la0_probe26,
    input  [1:0] la0_probe27,
    input  la0_probe28,
    input  la0_probe29,
    input  la0_probe30,
    input  [7:0] la0_probe31,
    input  [7:0] la0_probe32,
    input  [7:0] la0_probe33,
    input  [7:0] la0_probe34,
    input  la0_probe35,
    input  la0_probe36,
    input  [15:0] la0_probe37,
    input  la0_probe38,
    input  [7:0] la0_probe39,
    input  [7:0] la0_probe40,
    input  la0_probe41,
    input  [15:0] la0_probe42,
    input  la0_probe43,
    input  la0_probe44,
    input  [7:0] la0_probe45,
    input  la0_probe46,
    input  [7:0] la0_probe47,
    input  la0_probe48,
    input  la0_probe49,
    input  la0_probe50,
    input  [7:0] la0_probe51,
    input  la0_probe52,
    input  [7:0] la0_probe53,
    input  la0_probe54
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'h2e3b5081fd9246cfb185de210bc073a2 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 8 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 5 ),
